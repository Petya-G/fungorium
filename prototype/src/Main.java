...
public class Main {
    ...
    /**
     * program belépési pont, jelenleg a tesztelési menüt irányítja, illetve
     * létrehozza a tesztpályát és a tesztjátékosokat
     */
    public static void main(String[] args) {
        ...
        Insecter insecter1 = new Insecter(map.getTectons().get(4));
        Insecter insecter2 = new Insecter(map.getTectons().get(4));

        System.out.println("Creating mushroomers");
        Mushroomer mushroomer1 = new Mushroomer(map.getTectons().get(0));
        Mushroomer mushroomer2 = new Mushroomer(map.getTectons().get(0));
